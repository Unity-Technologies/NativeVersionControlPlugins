...
curl -fssL -o 'PerforceBinaries/OSX/p4'          'https://filehost.perforce.com/perforce/r24.1/bin.macosx1015x86_64/p4'
curl -fssL -o 'PerforceBinaries/OSX/p4d'         'https://filehost.perforce.com/perforce/r24.1/bin.macosx1015x86_64/p4d'
